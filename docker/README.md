...
official/supported Docker Images found at https://hub.docker.com/r/snowpuppycoin/snowpuppycoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/snowpuppycoin/snowpuppycoind-develop/ when changing the above text**