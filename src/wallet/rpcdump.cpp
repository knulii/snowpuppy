...
UniValue dumpwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"dumpwallet",
               ...
               {
                       {"filename", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The filename with path (either absolute or relative to snowpuppycoind)"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("snowpuppycoincoreversion", CLIENT_BUILD);
                    ...
                    result.pushKV(
                            ...
                            JSONRPCError(
                                    ...
                                    strprintf(
                                            ...
                                            "caused by pruning or data corruption (see snowpuppycoind log for details) and could "
