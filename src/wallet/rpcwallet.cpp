...
UniValue getnewaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getnewaddress",
               ...
               RPCResult{
                       RPCResult::Type::STR, "address", "The new snowpuppycoin address"
               },
               RPCExamples{
    ...
    RPCHelpMan{"setlabel",
               "\nSets the label associated with the given address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The snowpuppycoin address to be associated with a label."},
    ...
    RPCHelpMan{"sendtoaddress",
               ...
               HELP_REQUIRING_PASSPHRASE,
               {
                       ...
                       {"subtractfeefromamount", RPCArg::Type::BOOL, /* default */ "false",
                        ...
                        "                             The recipient will receive less amount of SPUPC than you enter in the amount field."},
                               ...
                               {RPCResult::Type::ARR, "", "",
                                {
                                        {RPCResult::Type::ARR, "", "",
                                         {
                                                 {RPCResult::Type::STR, "address", "The snowpuppycoin address"},
...
UniValue listaddressbalances(const JSONRPCRequest &request) {
    RPCHelpMan{"listaddressbalances",
               ...
               RPCResult{
                       ...
                       {
                               {RPCResult::Type::STR_AMOUNT, "amount",
                                "The snowpuppycoin address and the amount in " + CURRENCY_UNIT},
                       }
               },
               RPCExamples{
    ...
    RPCHelpMan{"sendmany",
               ...
               HELP_REQUIRING_PASSPHRASE,
               {
                       ...
                       {"subtractfeefrom", RPCArg::Type::ARR, RPCArg::Optional::OMITTED_NAMED_ARG,
                        ...
                        "                           Those recipients will receive less SPUPCs than you enter in their corresponding amount field.\n"
    ...
    RPCHelpMan{"addmultisigaddress",
               ...
               "If 'label' is specified, assign address to that label.\n",
               {
                       ...
                       {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO,
                        "A json array of snowpuppycoin addresses or hex-encoded public keys",
                        {
                                {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED,
                                 "snowpuppycoin address or hex-encoded public key"},
                        },
                       },
                               ...
                               {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                          {
                                                                              ...
                                                                              {
                                                                                  RPCResult::Type::STR, "address", "The snowpuppycoin address of the transaction. Not present for\n"
                               ...
                               {RPCResult::Type::ARR, "transactions", "",
                                {
                                        {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                                   {
                                                                                       { RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction" },
                                                                                       { RPCResult::Type::STR, "address", "The snowpuppycoin address of the transaction. Not present for move transactions (category = move)." },
                                        ...
                                        {RPCResult::Type::OBJ, "", "",
                                         {
                                                 ...
                                                 {RPCResult::Type::STR, "address",
                                                  "The snowpuppycoin address involved in the transaction."},
...
UniValue walletpassphrase(const JSONRPCRequest &request) {
    RPCHelpMan{"walletpassphrase",
               ...
               "This is needed prior to performing transactions related to private keys such as sending snowpuppycoin\n"
               "\nNote:\n"
...
UniValue encryptwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"encryptwallet",
               ...
               RPCExamples{
                       ...
                       "\nNow set the passphrase to use the wallet, such as for signing or sending snowpuppycoin\n"
...
UniValue lockunspent(const JSONRPCRequest &request) {
    RPCHelpMan{"lockunspent",
               ...
               "A locked transaction output will not be chosen by automatic coin selection, when spending snowpuppycoin.\n"
...
static UniValue loadwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"loadwallet",
               ...
               "\nNote that all wallet command-line options used when starting snowpuppycoind will be"
    ...
    RPCHelpMan{"listunspent",
               ...
               "Optionally filter to only include txouts paid to specified addresses.\n",
               {
                       ...
                       {"addresses", RPCArg::Type::ARR, /* default */ "empty array",
                        "A json array of snowpuppycoin addresses to filter",
                        {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "snowpuppycoin address"},
                        },
                       },
    ...
    if (!options.isNull()) {
        if (options.type() == UniValue::VBOOL) {
            ...
            if (options.exists("changeAddress")) {
                ...
                if (!IsValidDestination(dest)) {
                    throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid snowpuppycoin address");
                }
                       ...
                       {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG,
                        "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                                ...
                                {"subtractFeeFromOutputs", RPCArg::Type::ARR, /* default */ "empty array",
                                 ...
                                 "                              Those recipients will receive less SPUPC than you enter in their corresponding amount field.\n"
...
UniValue getaddressinfo(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressinfo",
               "\nReturn information about the given snowpuppycoin address. Some information requires the address\n"
               "to be in the wallet.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The snowpuppycoin address to get the information of."},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
                               {RPCResult::Type::STR, "address", "The snowpuppycoin address validated."},
