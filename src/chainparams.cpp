...
//        FindMainNetGenesisBlock(1730521201, 0x20001fff, "main");
        ...
        vSporkAddresses = {"SMpt2QrNGtgHkpJ3zZKTXgJumUoRw3i6ia"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
                1730521201,   // * UNIX timestamp of last known number of transactions (Block 0)
...
//        FindTestNetGenesisBlock(1730521202, 0x20001fff, "test");
        ...
        chainTxData = ChainTxData{
                1730521202, // * UNIX timestamp of last known number of transactions (Block 17670)
                0,    // * total number of transactions between genesis and that timestamp
...
public:
    explicit CDevNetParams(const ArgsManager &args) {
        ...
        genesis = CreateGenesisBlock(1730521203, 2841, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
       consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock ==
               uint256S("0x"));
