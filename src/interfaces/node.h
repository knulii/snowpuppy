...
//! Interface for the src/evo part of a snowpuppycoin node (snowpuppycoind process).
    class EVO {
    public:
        virtual ~EVO() {}
...
//! Interface for the src/llmq part of a snowpuppycoin node (snowpuppycoind process).
    class LLMQ {
    public:
        virtual ~LLMQ() {}
...
//! Interface for the src/smartnode part of a snowpuppycoin node (snowpuppycoind process).
    namespace Smartnode {
        class Sync {
        public:
            virtual ~Sync() {}
...
//! Top-level interface for a snowpuppycoin node (snowpuppycoind process).
    class Node {
    public:
        virtual ~Node() {}
