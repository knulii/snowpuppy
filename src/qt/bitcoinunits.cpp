...
QList <BitcoinUnits::Unit> BitcoinUnits::availableUnits() {
    ...
    unitlist.append(SPUPC);
    unitlist.append(mSPUPC);
    unitlist.append(uSPUPC);
...
QString BitcoinUnits::name(int unit) {
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        switch (unit) {
            case SPUPC:
                return QString("SPUPC");
            case mSPUPC:
                return QString("mSPUPC");
            case uSPUPC:
                return QString::fromUtf8("μSPUPC");
            case ruffs:
        ...
        switch (unit) {
            case SPUPC:
                return QString("tSPUPC");
            case mSPUPC:
                return QString("mtSPUPC");
            case uSPUPC:
                return QString::fromUtf8("μtSPUPC");
            case ruffs:
...
QString BitcoinUnits::formatWithCustomName(QString customName, const CAmount &amount, int unit, bool plussign,
    ...
    return format(SPUPC, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") +
           customName.left(20);
}
