...
bool Intro::pickDataDirectory(interfaces::Node &node) {
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) ||
        ...
        intro.setWindowIcon(QIcon(":icons/snowpuppycoin"));
     ...
     * override -datadir in the snowpuppycoin.conf file in the default data directory
     * (to be consistent with snowpuppycoind behavior)
     */
    if (dataDir != GUIUtil::getDefaultDataDirectory()) {
