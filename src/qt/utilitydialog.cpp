...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: snowpuppycoin-qt [command-line options]                     \n";
...
All the SnowPuppyCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SPUPC, 0.01 SPUPC, 0.1 SPUPC, 1 SPUPC and 10 SPUPC -- sort of like the paper money you use every day.</li> \
