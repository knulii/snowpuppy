...
void BitcoinGUI::createActions() {
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a SnowPuppyCoin address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a SnowPuppyCoin address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr(" Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and snowpuppycoin: URIs)"));
    receiveCoinsMenuAction->setToolTip(receiveCoinsMenuAction->statusTip());

    sendAssetsMenuAction = new QAction(tr(" Send Asset"), this);
    sendAssetsMenuAction->setStatusTip(tr("Send assets to a SnowPuppyCoin address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SnowPuppyCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(
            tr("Verify messages to ensure they were signed with specified SnowPuppyCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a snowpuppycoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(
            tr("Show the %1 help message to get a list with possible SnowPuppyCoin command-line options").arg(
                    PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SnowPuppyCoin network", "", count));
    } else {
