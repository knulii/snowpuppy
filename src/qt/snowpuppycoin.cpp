...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase,
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in snowpuppycoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in snowpuppycoin.qrc)
...
static const char *qt_argv = "spupc-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info) {
    ...
    if (success) {
        ...
        // snowpuppycoin: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char *argv[]) {
    ...
    Q_INIT_RESOURCE(snowpuppycoin);
    Q_INIT_RESOURCE(snowpuppycoin_locale);
    ...
    /// 6. Determine availability of data and blocks directory and parse snowpuppycoin.conf
    ...
    // snowpuppycoin: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
