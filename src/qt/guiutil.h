...
namespace GUIUtil {
    ...
    // Parse "snowpuppycoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load snowpuppycoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a snowpuppycoin specific theme is activated (light/dark).*/
