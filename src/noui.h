...
/** Connect all snowpuppycoind signal handlers */
void noui_connect();

/** Suppress all snowpuppycoind signal handlers. Used to suppress output during test runs that produce expected error. */
void noui_suppress();
