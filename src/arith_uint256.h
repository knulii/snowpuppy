...
#ifndef SNOWPUPPYCOIN_ARITH_UINT256_H
#define SNOWPUPPYCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Snowpuppycoin only uses this "compact" format for encoding difficulty
...
#endif // SNOWPUPPYCOIN_ARITH_UINT256_H
