...
https://github.com/raptor3um/snowpuppycoin_hash
...
JSON-RPC server. Running `snowpuppycoind` or `snowpuppycoin-qt -server` will be sufficient.
...
* `input`: snowpuppycoind blocks/ directory containing blkNNNNN.dat
