...
from test_framework.test_framework import SnowpuppycoinTestFramework
...
class LLMQChainLocksTest(SnowpuppycoinTestFramework):
    def set_test_params(self):
        self.set_snowpuppycoin_test_params(6, 5, fast_dip3_enforcement=True)
