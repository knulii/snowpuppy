...
"""Verify that starting snowpuppycoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start snowpuppycoind with -h for help text")
        ...
        self.log.info("Start snowpuppycoind with -version for version information")
        ...
        self.log.info("Start snowpuppycoind with -fakearg  to make sure it does not start")
