...
# Objects that map to snowpuppycoind objects, which can be serialized/deserialized
...
class msg_headers():
    ...
    def deserialize(self, f):
        # comment in snowpuppycoind indicates these should be deserialized as blocks
