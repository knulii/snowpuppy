Contributing to SnowPuppyCoin Core
============================

The SnowPuppyCoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to snowpuppycoin-qt
...
[Translation Process](https://github.com/Raptor3um/snowpuppycoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the SnowPuppyCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall SnowPuppyCoin
Network Protocol consensus changes.

Whether a pull request is merged into SnowPuppyCoin Core rests with the project merge
...
Patches that change SnowPuppyCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SnowPuppyCoin consensus, it must have been
...
The review process is normally fairly responsive on the SnowPuppyCoin Core repository, however
...
The project leader is the release manager for each SnowPuppyCoin Core release.
