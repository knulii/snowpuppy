# Support for Output Descriptors in SnowPuppyCoin Core

Since SnowPuppyCoin Core v0.17 with Future Lock Transactions, 
...
existing SnowPuppyCoin Core wallets, a convenience function `combo` is
...
All RPCs in SnowPuppyCoin Core will include the checksum in their output. Only
