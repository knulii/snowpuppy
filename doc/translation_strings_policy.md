...
This document provides guidelines for internationalization of the SnowPuppyCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `snowpuppycoin_en.ts` remains unchanged.
