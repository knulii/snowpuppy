...
* snowpuppycoin.conf: contains configuration settings for snowpuppycoind or snowpuppycoin-qt
* snowpuppycoind.pid: stores the process id of snowpuppycoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by snowpuppycoind or snowpuppycoin-qt
