...
This mechanism has been integrated into Bitcore-Node-Snowpuppycoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raptor3um/insight-api-snowpuppycoin#web-socket-api](https://github.com/raptor3um/insight-api-snowpuppycoin#web-socket-api)
* API: [https://github.com/raptor3um/insight-api-snowpuppycoin#instantsend-transactions](https://github.com/raptor3um/insight-api-snowpuppycoin#instantsend-transactions)
