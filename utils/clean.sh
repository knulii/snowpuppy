...
rm -f src/config/snowpuppycoin-config.h
...
rm -rf test_bitcoin.coverage/ snowpuppycoin-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_snowpuppycoin
clean_exe src/snowpuppycoin-cli
clean_exe src/snowpuppycoind
clean_exe src/snowpuppycoin-gtest
clean_exe src/test/test_snowpuppycoin
clean_exe src/test/test_snowpuppycoin_fuzzy
clean_exe src/qt/snowpuppycoin-qt
clean_exe src/qt/test/test_snowpuppycoin-qt
...
clean_dep . src/config/snowpuppycoin-config.h.in
